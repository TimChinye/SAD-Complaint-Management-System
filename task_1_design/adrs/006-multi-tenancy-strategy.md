...
2.  Implementing a centralised data access layer (e.g; Repositories) that automatically applies the tenant filter, abstracting this concern away from the core business logic.
